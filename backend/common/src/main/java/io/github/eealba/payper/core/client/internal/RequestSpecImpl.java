...
final class RequestSpecImpl<T, T2, R1, R2> implements RequestSpec<R1, R2>,
    ...
    RequestSpecImpl(Spec<T, R1, R2> spec) {
        ...
        PayperRequest.Method method = spec.getMethod();
        switch (method) {
            case GET:
                requestBuilder.GET();
                break;
            case DELETE:
                ...
                break;
            case POST:
                requestBuilder.POST(PayperRequest.BodyPublishers.noBody());
                break;
        }
    }
    /**
    ...
    public T withBody(T2 body) {
        ...
        switch (method) {
            case POST:
                ...
                break;
            case PUT:
                requestBuilder.PUT(PayperRequest.BodyPublishers.of(body));
                break;
            case PATCH:
                requestBuilder.PATCH(PayperRequest.BodyPublishers.of(body));
                break;
        }
        return self();
    }
