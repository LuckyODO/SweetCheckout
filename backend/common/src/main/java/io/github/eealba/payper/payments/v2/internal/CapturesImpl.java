...
class CapturesImpl implements Captures {
    ...
    public GetCapture get() {
        Spec<GetCapture, Capture2, ErrorDefault> spec = PayperProvider.provider().createSpecBuilder(GetCapture.class, payer,
    ...
    public RefundCapture refund() {
        Spec<RefundCapture, Refund, ErrorDefault> spec = PayperProvider.provider().createSpecBuilder(RefundCapture.class, payer,
