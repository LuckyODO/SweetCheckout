...
class OrdersImpl implements Orders {
    ...
    public CreateOrder create() {
        Spec<CreateOrder, Order, ErrorDefault> spec = PayperProvider.provider().createSpecBuilder(CreateOrder.class, payper,
    ...
    @Override
    public GetOrder get() {
        Spec<GetOrder, Order, ErrorDefault> spec = PayperProvider.provider().createSpecBuilder(GetOrder.class, payper, "/v2/checkout/orders/{id}",
    ...
    public UpdateOrder update() {
        Spec<UpdateOrder, Void, ErrorDefault> spec = PayperProvider.provider().createSpecBuilder(UpdateOrder.class, payper,
    ...
    public ConfirmPaymentSourceOrder confirmPaymentSource() {
        Spec<ConfirmPaymentSourceOrder, Order, ErrorDefault> spec = PayperProvider.provider().createSpecBuilder(ConfirmPaymentSourceOrder.class, payper,
    ...
    public AuthorizeOrder authorize() {
        Spec<AuthorizeOrder, OrderAuthorizeResponse, ErrorDefault> spec = PayperProvider.provider().createSpecBuilder(AuthorizeOrder.class, payper,
    ...
    public CaptureOrder capture() {
        Spec<CaptureOrder, Order, ErrorDefault> spec = PayperProvider.provider().createSpecBuilder(CaptureOrder.class, payper,
    ...
    public TrackOrder track() {
        Spec<TrackOrder, Order, ErrorDefault> spec = PayperProvider.provider().createSpecBuilder(TrackOrder.class, payper,
    ...
    public UpdateTrackingOrder updateTracking() {
        Spec<UpdateTrackingOrder, Void, ErrorDefault> spec = PayperProvider.provider().createSpecBuilder(UpdateTrackingOrder.class, payper,
