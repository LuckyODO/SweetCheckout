...
class AuthorizationsImpl implements Authorizations {
    ...
    public GetAuthorization get() {
        Spec<GetAuthorization, Authorization2, ErrorDefault> spec = PayperProvider.provider().createSpecBuilder(GetAuthorization.class, payper,
    ...
    public CaptureAuthorization capture() {
        Spec<CaptureAuthorization, Capture2, ErrorDefault> spec = PayperProvider.provider().createSpecBuilder(CaptureAuthorization.class, payper,
    ...
    public ReauthorizeAuthorization reauthorize() {
        Spec<ReauthorizeAuthorization, Authorization2, ErrorDefault> spec = PayperProvider.provider().createSpecBuilder(ReauthorizeAuthorization.class, payper,
    ...
    public VoidAuthorization voidAuthorization() {
        Spec<VoidAuthorization, Authorization2, ErrorDefault> spec = PayperProvider.provider().createSpecBuilder(VoidAuthorization.class, payper,
